          ...
          (isLoading)
            ...
            child: RaisedButton(
              onPressed: () async {
                ...
                bool result = await context.read<TransactionCubit>()
                ...
                if (result == true) {
                  ...
                  Get.snackbar("title", "message",
                      ...
                      icon: Icon(
                        MdiIcons.closeCircleOutline, color: Colors.white,),
                      titleText: Text(
                        'Transaction Failed', style: GoogleFonts.poppins(
                          color: Colors.white,
                      ...
                      messageText: Text(
                        'Please try again later', style: GoogleFonts.poppins(
                          color: Colors.white,
                          fontWeight: FontWeight.w600
                      ),
